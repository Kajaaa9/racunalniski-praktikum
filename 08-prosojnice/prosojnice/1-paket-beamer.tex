...
\begin{frame}{Tudi v predstavitvah lahko pišemo izreke in dokaze}
	...
	\begin{proof}
	   ...
	   \begin{itemize}[<+->]
		  \item Naj bo $p$ \alert<4>{največje} praštevilo.  % !   <1-3> \alert deluje od prosojnice 1 do 3 (zaradi postopnega odpiranja je več prosojnic)
		  \item Naj bo $q$ produkt števil $1$, $2$, \ldots, $p$.
		  \item Število $q+1$ ni deljivo z nobenim praštevilom, torej je $q+1$ praštevilo.
		  \item To je protislovje, saj je $q+1>p$. \qedhere  % \qedhere ... kam naj se postavi znakec za konec dokaza
	   \end{itemize}
	\end{proof}
 \end{frame}
