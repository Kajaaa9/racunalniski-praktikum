...
\begin{frame}{Okolje \texttt{align} in \texttt{align*}}
	...
	\begin{align*}
				(a+b)^n \only<1>{&= \ldots \\}
		\onslide<2->{&= (a+b) (a+b) \dots (a+b) \\}  % ! nujno na koncu \\
...
\begin{frame}{Še ena uporaba okolja \texttt{align*}}
	...
	\begin{align*}
	y &= x^2 - 3|x| + 2   & y &= 3 \sin(\pi+x) - 2 \\%					!!! prvi & za poravnavo, drugi za nov stolpec
	y &= \log_2(x-2) + 3  & y &= 2 \sqrt{x^2+15} + 6 \\
	y &= 2^{x-3} + 1      & y &= \cos(x-3) + \sin^2(x+1) 
	\end{align*}
\end{frame}

\begin{frame}{Okolje \texttt{multline}}			%						!!! kadar je formula cez vec vrstic
	% Naloga 3.2.4:
