...
\begin{frame}{Odkrivanje tabele po stolpcih}
	...
	\begin{center}
		\begin{tabular}{c|>{\onslide<2->}c>{\onslide<3->}c>{\onslide<4->}c>{\onslide<5->}c<{\onslide}} % zadnji on slide zato da kar sledi (navpicna crta), da mora biti na vseh prosojnicah
